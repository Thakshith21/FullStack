...
# Load overlay images - IMPORTANT: Ensure these paths are correct and images exist
# Note: Your script uses sys.argv[3], sys.argv[4], sys.argv[5] for parts of the image filenames.
# Make sure the actual filenames (e.g., "irdai-60.png", "payal-110.png") exist at these paths.
...
def draw_responsive_subtitle(draw, base_position, text, font, fill, max_width=200, max_lines=2):
    ...
    while True:
        ...
        for word in words:
            ...
            # Using textsize instead of textbbox for width calculation
    ...
    for line in lines:
        ...
        # Using textsize for height calculation
...
draw_responsive_subtitle(
    ...
    text=subtitle,
    font=font_subtitle,
    fill="black", max_width=200,
    max_lines=3
)

# Names
draw.text((430, 140), facname1, font=font_name_large, fill="white")
draw.text((545, 140), facname2, font=font_name_small, fill="white")

# Designations
draw.text((430, 155), facdesc1, font=font_designation, fill="white")
draw.text((560, 155), facdesc2, font=font_designation, fill="white")
