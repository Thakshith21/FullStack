...
# --- MAIN SCRIPT ---
base = Image.open(f"/var/www/html/thakshith/templatetool1/inputimg/push/push-{template}.png").convert("RGBA")

# Load images
logo = Image.open(f"/var/www/html/thakshith/templatetool1/examlogos/{logo}-60.png").convert("RGBA")
himanshu = Image.open(f"/var/www/html/thakshith/templatetool1/facimg/{facimg1}-75.png").convert("RGBA")
sanyam = Image.open(f"/var/www/html/thakshith/templatetool1/facimg/{facimg2}-75.png").convert("RGBA")
...
# Load fonts
font_title = ImageFont.truetype(bold_font_path, 18)
...
"""
# Center-aligned Title with Stroke
custom_center_x = 125  # You can adjust this X
custom_center_y = 100   # And adjust this Y

title_width, title_height = draw.textsize(title, font=font_title)
title_x = custom_center_x - (title_width // 2)
title_y = custom_center_y - (title_height // 2)
...
draw.text((310, 145), facname2, font=font_name, fill="white")

# Designations
draw.text((235, 155), facdesc1, font=font_designation, fill="white")
draw.text((315, 155), facdesc2, font=font_designation, fill="white")
"""
...
draw.text((225 + (75 - name1_width) // 2, 145), facname1, font=font_name, fill="white")
draw.text((300 + (75 - name2_width) // 2, 145), facname2, font=font_name, fill="white")

# Centered Faculty Designations
desc1_width, _ = draw.textsize(facdesc1, font=font_designation)
desc2_width, _ = draw.textsize(facdesc2, font=font_designation)
draw.text((225 + (75 - desc1_width) // 2, 155), facdesc1, font=font_designation, fill="white")
draw.text((300 + (75 - desc2_width) // 2, 155), facdesc2, font=font_designation, fill="white")
...
# Save final image
base.save("/var/www/html/thakshith/templatetool1/output/push.png")
