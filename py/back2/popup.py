...
# --- MAIN SCRIPT ---
base = Image.open("../inputimg/popup.png").convert("RGBA")
...
draw.text((500, 245), facname2, font=font_name, fill="white")

# Designations
draw.text((380, 260), facdesc1, font=font_designation, fill="white")
draw.text((490, 260), facdesc2, font=font_designation, fill="white")
